...
import com.bezkoder.springjwt.config.Config;
...
public class PaymentController {
    ...
    @GetMapping("payment/create_payment")
    public ResponseEntity<?> createPaymet() throws UnsupportedEncodingException {
